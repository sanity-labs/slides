 ...
 *
 * **Imports:**
 *   - `@sanity-labs/slides`              — the Template value (`sanity`)
 *   - `@sanity-labs/slides/tokens`       — typed token catalog (per-category exports)
 *   - `@sanity-labs/slides/primitives`   — token-typed primitive layer
 *   - `@sanity-labs/slides/brand`        — chrome + text helpers used by every slide
 */

import { CANVAS_16_9, defineTemplate, defineTemplateComponent } from 'react-pptx';
